...
class PrayerDataFetchScheduleService : JobService(), PrayerPresenter.PrayerViewCallback {
    ...
    override fun onPrayerDetailSuccess(prayerApiResponse: PrayerApiResponse?) {
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), sunsetTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), asrTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), ishaTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), fajrTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), dhuhrTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), maghribTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), sunriseTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), midnightTimingsModel, null, autoUpdate = true)
        ...
        RoomHelper.transactAmendAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), imsakTimingsModel, null, autoUpdate = true)
