...
class PrayerDataFetchScheduleService : JobService(), PrayerPresenter.PrayerViewCallback {
    ...
    override fun onPrayerDetailSuccess(prayerApiResponse: PrayerApiResponse?) {
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), sunsetTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), asrTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), ishaTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), fajrTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), dhuhrTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), maghribTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), sunriseTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), midnightTimingsModel, autoUpdate = true)
        ...
        RoomRepository.amendTimingsAsync(AppDatabase.getAppDatabase(applicationContext), AlarmOps.Add.toString(), imsakTimingsModel, autoUpdate = true)
